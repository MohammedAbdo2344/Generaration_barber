    ...
    <section id="Regester" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p> <a href="Login.html" class="btn-get-started scrollto">Login </a> or <a href="signup.html" class="btn-get-started scrollto">Sign up </a> to make Appointment </p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/Barbers/1.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4><?php  $sql = "SELECT * FROM `barbers` WHERE `id`=1";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["name"] ?></h4>
                  <a href="https://www.facebook.com/boody.abdo.963/  "><i class="ri-facebook-fill"></i></a>
                  <a href="https://www.instagram.com/mohammedabdo30/channel/  "><i class="ri-instagram-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 ">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/Barbers/3.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4><?php  $sql = "SELECT * FROM `barbers` WHERE `id`=2";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["name"] ?> </h4>
              
                <div class="social">
                  <a href="https://www.facebook.com/SheTos.B"><i class="ri-facebook-fill"></i></a>
                  <a href="https://www.instagram.com/basselshalan_/"><i class="ri-instagram-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 ">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/Barbers/2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4><?php  $sql = "SELECT * FROM `barbers` WHERE `id`=3";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["name"] ?></h4>

                <div class="social">                  
                  <a href="https://www.facebook.com/antonios.micheal.5"><i class="ri-facebook-fill"></i></a>
                  <a href="https://www.instagram.com/antonious.antony/"><i class="ri-instagram-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6  ">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/Barbers/7.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4><?php  $sql = "SELECT * FROM `barbers` WHERE `id`=4";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["name"] ?> </h4>

                <div class="social">
                  <a href="https://www.facebook.com/A7med.Megahed.98"><i class="ri-facebook-fill"></i></a>
                  <a href="https://www.instagram.com/ahmed_megahed98/"><i class="ri-instagram-fill"></i></a>
                </div>
              </div>
            </div>
          </div>
