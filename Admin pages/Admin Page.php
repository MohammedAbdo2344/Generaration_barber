...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <h1 class="Allred"> Welcome to Generation Z</h1>
      ...
      <a href="../php/Admin index.php" class="btn-get-started scrollto">Customize Users</a>
      <a href="../php/Appointment index.php" class="btn-get-started scrollto">Customize Appointment </a>
  ...
  <main id="main">
    ...
    <section id="Barbers" class="Barbers">
      <div class="container">
        ...
        <a href="../php/Barbers index.php" >Customize Barbers</a>
