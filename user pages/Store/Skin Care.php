  ...
  <div class="container d-flex align-items-center">
    ...
    <nav class="nav-menu d-none d-lg-block">
      <ul>
        ...
        <li class="active"><a href="../../php/cart.php">cart</a></li>
      </ul>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 d-flex align-items-stretch" >
        <form method="post" action="../../php/cart.php?action=add&id=<?php echo $row["id"]; ?>">
          <div class="icon-box">
            <div  class="icon"><img style="height: 65px; width: 65px;" src="<?php echo $row["image"]; ?>"></div>
            <h4><?php echo $row["name"] ?></h4>
            <p><?php  echo $row["price"] ?> EGP </p>
            <input type="text" name="quantity" value="1" class="form-control" />
            <input type="hidden" name="hidden_name" value="<?php echo $row["name"]; ?>" />
            <input type="hidden" name="hidden_price" value="<?php echo $row["price"]; ?>" />
            <input type="submit" name="add_to_cart" style="margin-top:5px; background-color: #1977cc;" class="btn btn-success" value="Add to Cart" />
