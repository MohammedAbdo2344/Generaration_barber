...
{
  $sql="select * from appointment where id=".$_REQUEST["id"];
...
<div class="login-page">
    <div class="form">
      ...
      <form action="appointment.php" method="GET"  class="register-form"> 
        <input type="text" placeholder="name" name="name" required />
        <input type="email" placeholder="E-mail" name="E-mail" required/>
        <input type="number" placeholder="Phone Number" name="PN" required/>
