    ...
    <section id="services" class="services">
        <div class="container">
          ...
          <?php  
            ...
            $sql = "SELECT * FROM `skincare`  ORDER BY id ASC";
            $result = mysqli_query($conn, $sql);
          ?>
          <div class="row">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="icon-box">
                <div class="icon"><img style="height: 65px; width: 65px;" src="../assets/img/Store/1.png"></i></div>
                <h4><?php  $sql = "SELECT * FROM `skincare` WHERE `id`=1 ";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["name"] ?>   </h4>
                <p><?php  $sql = "SELECT * FROM `skincare` WHERE `id`=1 ";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["price"] ?> EGP</p>           
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="icon-box">
                <div class="icon"><img style="height: 65px; width: 65px;" src="../assets/img/Store/1.png"></i></div>
                <h4><?php  $sql = "SELECT * FROM `skincare` WHERE `id`=2 ";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["name"] ?>   </h4>
                <p><?php  $sql = "SELECT * FROM `skincare` WHERE `id`=2 ";$result = mysqli_query($conn, $sql); $row = mysqli_fetch_array($result);echo $row["price"] ?> EGP</p>           
